...
{
	commandList.push_back(new Command(previousCommand.time,previousCommand.value,previousCommand.angle ));
...
int main(int argc, char **argv)
{
  ...
  ros::Suscriber ordre = n.suscribe("ordreDeLAmiral", 1000, enAvantToute)
